jQuery.sap.require("scnmeetuppoa.sapui5.demo1.util.Formatter");

sap.ui.core.mvc.Controller.extend("scnmeetuppoa.sapui5.demo1.view.Master", {
	...
	onAddProduct : function() {
		sap.ui.core.UIComponent.getRouterFor(this).myNavToWithoutHash({
			...
			targetViewName : "scnmeetuppoa.sapui5.demo1.view.AddProduct",
			targetViewType : "XML",
			transition : "slide"
		});
	}
