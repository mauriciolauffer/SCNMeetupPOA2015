sap.ui.core.mvc.Controller.extend("scnmeetuppoa.sapui5.demo1.view.AddProduct", {
	...
	onSave : function() {
		...
		if (!this.getView().getModel("newProduct").getProperty("/Detail/Name")) {
			if (!this.oAlertDialog) {
				this.oAlertDialog = sap.ui.xmlfragment("scnmeetuppoa.sapui5.demo1.view.NameRequiredDialog", this);
