sap.ui.core.mvc.Controller.extend("scnmeetuppoa.sapui5.demo1.view.Detail", {
		...
		sap.ui.core.UIComponent.getRouterFor(this).attachRouteMatched(function(oEvent) {
			...
			if (oEvent.getParameter("name") === "product") {
				...
				oView.getElementBinding().attachEventOnce("dataReceived", jQuery.proxy(function() {
					...
					if (!oData) {
						sap.ui.core.UIComponent.getRouterFor(this).myNavToWithoutHash({
							currentView : oView,
							targetViewName : "scnmeetuppoa.sapui5.demo1.view.NotFound",
							targetViewType : "XML"
						});
					}
				}, this));
				...
				oIconTabBar.getItems().forEach(function(oItem) {
					oItem.bindElement(scnmeetuppoa.sapui5.demo1.util.Formatter.uppercaseFirstChar(oItem.getKey()));
				});
